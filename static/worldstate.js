...
function rotateNewsImage(newsImageArray) {
    ...
    // If there's an existing interval, clear it before setting a new one
    if (newsInterval) {
    ...
    newsInterval = setInterval(() => {
        ...
        document.querySelectorAll('a').forEach(a => a.style.color = '');  // Reset color of all links

        if (linkElement) {
            linkElement.style.color = 'white';  // Highlight the current link
        }
